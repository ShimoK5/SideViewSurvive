...
public class InputManager_FU : MonoBehaviour
{
    //実体
    public static InputManager_FU instanse;
    ...
    static int INPUT_COOL_CNT = 30;     //最初の長押し取得から何フレーム待つか
    static int INPUT_CYCLE_CNT = 10;    //長押し時のサイクルフレーム数
